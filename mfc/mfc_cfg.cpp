...
BOOL FASTCALL CConfig::Init()
{
	...
	CString sz;	// Get the full file name and assign it to NombreArchivoXM6
...
//	OutputDebugString("\n\n NombreFileXm6:" + m_pFrmWnd->NombreFileXM6 + "\n\n");
//   MessageBox(NULL, m_pFrmWnd->NombreFileXM6, "Xm6", 2);
	...
	// Data de configuracion -> Aqui se carga la configuraciÅEΩn *-*
	LoadConfig();
	...
	if(m_pFrmWnd->RutaCompletaArchivoXM6.GetLength()>0)// Si RutaCompletaFileXM6 ya esta ocupado
	{
...
BOOL FASTCALL CConfig::CustomInit(BOOL ArchivoDefault)
{
	...
	// Get nombre archivo de juego actual y remover extensiÅEΩn
	int nLen = m_pFrmWnd->NombreArchivoXM6.GetLength();
	TCHAR lpszBuf[MAX_PATH];
	_tcscpy(lpszBuf, m_pFrmWnd->NombreArchivoXM6.GetBuffer(nLen));
	PathRemoveExtensionA(lpszBuf);
...
void FASTCALL CConfig::GetConfig(Config *pConfigBuf) const
{
	...
	// ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ[ÅEΩNÅEΩÅEΩCopiar
	*pConfigBuf = m_Config;
}

//---------------------------------------------------------------------------
//
//	ÅEΩ›íÔøΩfÅEΩ[ÅEΩ^ÅEΩ›íÔøΩ
//
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
//
//	INIÅEΩtÅEΩ@ÅEΩCÅEΩÅEΩÅEΩeÅEΩ[ÅEΩuÅEΩÅEΩ
//	ÅEΩÅEΩÅEΩ|ÅEΩCÅEΩÅEΩÅEΩ^ÅEΩEÅEΩZÅEΩNÅEΩVÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩEÅEΩLÅEΩ[ÅEΩÅEΩÅEΩEÅEΩ^ÅEΩEÅEΩfÅEΩtÅEΩHÅEΩÅEΩÅEΩgÅEΩlÅEΩEÅEΩ≈èÔøΩÅEΩlÅEΩEÅEΩ≈ëÔøΩlÅEΩÃèÔøΩ
//
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
//
//	ÅEΩ›íÔøΩfÅEΩ[ÅEΩ^ÅEΩÅEΩÅEΩ[ÅEΩh
//
//---------------------------------------------------------------------------
void FASTCALL CConfig::LoadConfig()
{
	...
	// ÅEΩeÅEΩ[ÅEΩuÅEΩÅEΩÅEΩÃêÊì™ÅEΩ…çÔøΩÅEΩÌÇπÅEΩÅEΩ
	pIni = (const PINIKEY)&IniTable[0];
	pszSection = NULL;
	szDef[0] = _T('\0');

	// ÅEΩeÅEΩ[ÅEΩuÅEΩÅEΩBucle
	while (pIni->pBuf) {
		// ÅEΩZÅEΩNÅEΩVÅEΩÅEΩÅEΩÅEΩÅEΩ›íÔøΩ
		if (pIni->pszSection) {
		...
		// ÅEΩ^ÅEΩCÅEΩvCheck
		switch (pIni->nType) {
			// ÅEΩÅEΩÅEΩÅEΩÅEΩ^(ÅEΩÕàÕÇí¥ÇÔøΩÅEΩÅEΩÅEΩÅEΩfÅEΩtÅEΩHÅEΩÅEΩÅEΩgÅEΩl)
			case 0:
			...
			// ÅEΩ_ÅEΩÅEΩÅEΩ^(0,1ÅEΩÃÇ«ÇÔøΩÅEΩÅEΩ≈ÇÔøΩÅEΩ»ÇÔøΩÅEΩÅEΩŒÉfÅEΩtÅEΩHÅEΩÅEΩÅEΩgÅEΩl)
			case 1:
			...
			// ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ^(ÅEΩoÅEΩbÅEΩtÅEΩ@ÅEΩTÅEΩCÅEΩYÅEΩÕàÕìÔøΩÅEΩ≈ÇÃÉ^ÅEΩ[ÅEΩ~ÅEΩlÅEΩ[ÅEΩgÅEΩÅEΩ€èÔøΩ)
			case 2:
				...
				// ÅEΩfÅEΩtÅEΩHÅEΩÅEΩÅEΩgÅEΩlÅEΩ…ÇÕÉoÅEΩbÅEΩtÅEΩ@ÅEΩTÅEΩCÅEΩYÅEΩÅEΩÅEΩLÅEΩÅEΩÅEΩÅEΩÅEΩÈÇ±ÅEΩÅEΩ
				ASSERT(pIni->nDef > 0);
...
//---------------------------------------------------------------------------
//
//	SASIÅEΩÅEΩÅEΩZÅEΩbÅEΩg
//	ÅEΩÅEΩversion1.44ÅEΩ‹Ç≈ÇÕéÔøΩÅEΩÅEΩÅEΩtÅEΩ@ÅEΩCÅEΩÅEΩBusquedaÅEΩÃÇÔøΩÅEΩﬂÅAÅEΩÅEΩÅEΩÅEΩÅEΩ≈çÔøΩBusquedaÅEΩ∆ê›íÔøΩÅEΩÅEΩsÅEΩÅEΩ
//	version1.45ÅEΩ»ç~ÅEΩ÷ÇÃà⁄çsÅEΩÅEΩÅEΩXÅEΩÅEΩÅEΩ[ÅEΩYÅEΩ…çsÅEΩÅEΩ
//
//---------------------------------------------------------------------------
void FASTCALL CConfig::ResetSASI()
{
	...
	// Number of drives>=0ÅEΩÃèÍçáÅEΩÕïsÅEΩv(ÅEΩ›íÔøΩœÇÔøΩ)
	...
	// ÅEΩ≈èÔøΩÅEΩÅEΩÅEΩÅEΩCheckÅEΩÅEΩÅEΩƒÅAÅEΩLÅEΩÅEΩÅEΩÅEΩNumber of drivesÅEΩÅEΩÅEΩÅEΩÅEΩﬂÇÔøΩ
	for (i=0; i<16; i++) {
		...
		// ÅEΩTÅEΩCÅEΩYCheck(version1.44ÅEΩ≈ÇÔøΩ40MBÅEΩhÅEΩÅEΩÅEΩCÅEΩuÅEΩÃÇ›ÉTÅEΩ|ÅEΩ[ÅEΩg)
		if (fio.GetFileSize() != 0x2793000) {
			fio.Close();
			return;
		}

		// ÅEΩJÅEΩEÅEΩÅEΩÅEΩgÅEΩAÅEΩbÅEΩvÅEΩ∆ÉNÅEΩÅEΩÅEΩ[ÅEΩY
...
//---------------------------------------------------------------------------
//
//	CD-ROMÅEΩÅEΩÅEΩZÅEΩbÅEΩg
//	ÅEΩÅEΩversion2.02ÅEΩ‹Ç≈ÇÔøΩCD-ROMÅEΩÅEΩÅEΩTÅEΩ|ÅEΩ[ÅEΩgÅEΩÃÇÔøΩÅEΩﬂÅASCSINumber of drivesÅEΩÅEΩ+1ÅEΩÅEΩÅEΩÅEΩ
//
//---------------------------------------------------------------------------
void FASTCALL CConfig::ResetCDROM()
{
	...
	// CD-ROMÅEΩtÅEΩÅEΩÅEΩOÅEΩÅEΩÅEΩZÅEΩbÅEΩgÅEΩÅEΩÅEΩÅEΩƒÇÔøΩÅEΩÅEΩÍçÅEøΩÕïsÅEΩv(ÅEΩ›íÔøΩœÇÔøΩ)
	if (m_bCDROM) {
		return;
	}

	// CD-ROMÅEΩtÅEΩÅEΩÅEΩOÅEΩÅEΩÅEΩZÅEΩbÅEΩg
	m_bCDROM = TRUE;

	// SCSINumber of drivesÅEΩÅEΩ3ÅEΩ»èÔøΩ6ÅEΩ»âÔøΩÅEΩÃèÍçáÅEΩ…åÔøΩÅEΩÅEΩA+1
...
void FASTCALL CConfig::LoadMRU(int nType)
{
	...
	// ÅEΩZÅEΩNÅEΩVÅEΩÅEΩÅEΩÅEΩCreate
...
void FASTCALL CConfig::SetMRUFile(int nType, LPCTSTR lpszFile)
{
	...
	// ÅEΩÅEΩÅEΩ…ìÔøΩÅEΩÅEΩÅEΩÅEΩÅEΩÃÇÔøΩÅEΩ»ÇÔøΩÅEΩÅEΩ
	nNum = GetMRUNum(nType);
	for (nMRU=0; nMRU<nNum; nMRU++) {
		if (_tcscmp(m_MRUFile[nType][nMRU], lpszFile) == 0) {
			// ÅEΩÊì™ÅEΩ…ÇÔøΩÅEΩÅEΩÅEΩƒÅAÅEΩ‹ÇÔøΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÃÇÔøΩAgregarÅEΩÅEΩÅEΩÊÇ§ÅEΩ∆ÇÔøΩÅEΩÅEΩ
			if (nMRU == 0) {
				return;
			}
...
void FASTCALL CConfig::LoadKey() const
{
	...
	// ÅEΩtÅEΩÅEΩÅEΩOOFF(ÅEΩLÅEΩÅEΩÅEΩfÅEΩ[ÅEΩ^ÅEΩ»ÇÔøΩ)ÅEΩALimpiar
	bFlag = FALSE;
	...
	for (i=0; i<0x100; i++) {
		...
		// ÅEΩlÅEΩÅEΩÅEΩÕàÕìÔøΩÅEΩ…éÔøΩÅEΩ‹ÇÔøΩÅEΩƒÇÔøΩÅEΩ»ÇÔøΩÅEΩÅEΩŒÅAÅEΩÅEΩÅEΩÅEΩÅEΩ≈ë≈ÇÔøΩÅEΩÿÇÔøΩ(ÅEΩfÅEΩtÅEΩHÅEΩÅEΩÅEΩgÅEΩlÅEΩÅEΩÅEΩgÅEΩÅEΩ)
		if ((nValue < 0) || (nValue > 0x73)) {
			return;
		}

		// ÅEΩlÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩŒÉZÅEΩbÅEΩgÅEΩÅEΩÅEΩƒÅAÅEΩtÅEΩÅEΩÅEΩOÅEΩÅEΩÅEΩƒÇÔøΩ
		if (nValue != 0) {
			dwMap[i] = nValue;
			bFlag = TRUE;
		}
	...
	// ÅEΩtÅEΩÅEΩÅEΩOÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩƒÇÔøΩÅEΩÅEΩŒÅAÅEΩ}ÅEΩbÅEΩvÅEΩfÅEΩ[ÅEΩ^ÅEΩ›íÔøΩ
	if (bFlag) {
...
void FASTCALL CConfig::SaveKey() const
{
	...
	// ÅEΩ}ÅEΩbÅEΩvÅEΩfÅEΩ[ÅEΩ^ÅEΩÊìæ
	pInput->GetKeyMap(dwMap);

	// Bucle
	for (i=0; i<0x100; i++) {
		// ÅEΩÅEΩÅEΩ◊ÇÔøΩ(256ÅEΩÅEΩÅEΩ)ÅEΩÅEΩÅEΩÅEΩ
		strName.Format(_T("Key%d"), i);
...
void FASTCALL CConfig::SaveTKey() const
{
	...
	// ÅEΩLÅEΩ[ÅEΩ}ÅEΩbÅEΩvÅEΩÊìæ
	pTKey->GetKeyMap(nMap);

	// Bucle
	for (i=0; i<0x73; i++) {
		// ÅEΩÅEΩÅEΩ◊ÇÔøΩ(0x73ÅEΩÅEΩÅEΩ)ÅEΩÅEΩÅEΩÅEΩ
		strName.Format(_T("Key%d"), i);
...
BOOL FASTCALL CConfig::Save(Fileio *pFio, int /*nVer*/)
{
	...
	// ÅEΩTÅEΩCÅEΩYÅEΩÅEΩÅEΩZÅEΩ[ÅEΩu
	sz = sizeof(m_Config);
	if (!pFio->Write(&sz, sizeof(sz))) {
		return FALSE;
	}

	// ÅEΩ{ÅEΩÃÇÔøΩÅEΩZÅEΩ[ÅEΩu
...
BOOL FASTCALL CConfig::Load(Fileio *pFio, int nVer)
{
	...
	// ÅEΩ»ëOÅEΩÃÉoÅEΩ[ÅEΩWÅEΩÅEΩÅEΩÅEΩÅEΩ∆ÇÃå›äÔøΩ
	if (nVer <= 0x0201) {
		return Load200(pFio);
	}
	if (nVer <= 0x0203) {
	...
	// ÅEΩTÅEΩCÅEΩYÅEΩÅEΩÅEΩÅEΩÅEΩ[ÅEΩhÅEΩAÅEΩ∆çÔøΩ
	...
	// ÅEΩ{ÅEΩÃÇÔøΩÅEΩÅEΩÅEΩ[ÅEΩh
	if (!pFio->Read(&m_Config, (int)sz)) {
		return FALSE;
	}

	// ApplyCfgÅEΩvÅEΩÅEΩÅEΩtÅEΩÅEΩÅEΩOÅEΩÅEΩÅEΩ„Ç∞ÅEΩÅEΩ
	m_bApply = TRUE;
...
BOOL FASTCALL CConfig::Load200(Fileio *pFio)
{
	...
	// ÅEΩLÅEΩÅEΩÅEΩXÅEΩgÅEΩÅEΩÅEΩƒÅAversion2.00ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ[ÅEΩhÅEΩ≈ÇÔøΩÅEΩÅEΩÊÇ§ÅEΩ…ÇÔøΩÅEΩÅEΩ
	...
	// ÅEΩVÅEΩKÅEΩÅEΩÅEΩÅEΩ(Config202)ÅEΩÅEΩInitialization
	m_Config.mem_type = 1;
	...
	// ÅEΩVÅEΩKÅEΩÅEΩÅEΩÅEΩ(Config204)ÅEΩÅEΩInitialization
...
BOOL FASTCALL CConfig::Load202(Fileio *pFio)
{
	...
	// ÅEΩLÅEΩÅEΩÅEΩXÅEΩgÅEΩÅEΩÅEΩƒÅAversion2.02ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ[ÅEΩhÅEΩ≈ÇÔøΩÅEΩÅEΩÊÇ§ÅEΩ…ÇÔøΩÅEΩÅEΩ
...
BOOL FASTCALL CConfig::IsApply()
{
	...
	// ÅEΩvÅEΩÅEΩÅEΩ»ÇÔøΩAÅEΩÅEΩÅEΩÅEΩÅEΩ≈âÔøΩÅEΩÅE∑
	if (m_bApply) {
		m_bApply = FALSE;
		return TRUE;
	}

	// ÅEΩvÅEΩÅEΩÅEΩÅEΩÅEΩƒÇÔøΩÅEΩ»ÇÔøΩ
	return FALSE;
}

//===========================================================================
//
//	ConfigurationÅEΩvÅEΩÅEΩÅEΩpÅEΩeÅEΩBÅEΩyÅEΩ[ÅEΩW
//
//===========================================================================
...
{
	// ÅEΩÅEΩÅEΩÅEΩÅEΩoÅEΩœêÔøΩLimpiar
	m_dwID = 0;
	m_nTemplate = 0;
	m_uHelpID = 0;
	m_uMsgID = 0;
...
BOOL CConfigPage::OnInitDialog()
{
	...
	// ÅEΩeÅEΩEÅEΩBÅEΩÅEΩÅEΩhÅEΩEÅEΩÅEΩÅEΩÅEΩ›íÔøΩfÅEΩ[ÅEΩ^ÅEΩÅEΩÅEΩÛÇØéÔøΩÅEΩ
...
BOOL CConfigPage::OnSetCursor(CWnd *pWnd, UINT nHitTest, UINT nMsg)
{
	...
	// AyudaÅEΩÅEΩÅEΩwÅEΩËÇ≥ÅEΩÅEΩƒÇÔøΩÅEΩÈÇ±ÅEΩÅEΩ
	ASSERT(this);
	ASSERT(m_uHelpID > 0);

	// ÅEΩ}ÅEΩEÅEΩXÅEΩ íuÅEΩÊìæ
	GetCursorPos(&pt);

	// ÅEΩqÅEΩEÅEΩBÅEΩÅEΩÅEΩhÅEΩEÅEΩÅEΩÅEΩ‹ÇÔøΩÅEΩÅEΩƒÅAÅEΩÅEΩ`ÅEΩÅEΩÅEΩ…à íuÅEΩÅEΩÅEΩÈÇ©ÅEΩÅEΩÅEΩ◊ÇÔøΩ
	nID = 0;
	rectParent.top = 0;
	...
	// Bucle
	while (pChildWnd) {
		// AyudaIDÅEΩÅEΩÅEΩgÅEΩ»ÇÔøΩXÅEΩLÅEΩbÅEΩv
		...
		// ÅEΩÅEΩÅEΩÅEΩÅEΩ…ÇÔøΩÅEΩÈÇ©
		if (rectChild.PtInRect(pt)) {
			// ÅEΩÅEΩÅEΩ…éÊìæÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ`ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩŒÅAÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ
			if (rectParent.top == 0) {
				// ÅEΩ≈èÔøΩÅEΩÃåÔøΩÅEΩ
	...
	// ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ[ÅEΩhÅEΩAÅEΩ›íÔøΩ
...
void CBasicPage::OnMPUFull()
{
	...
	// ÅEΩIÅEΩtÅEΩ»ÇÔøΩNo hacer nada
	if (pButton->GetCheck() == 0) {
		return;
	}

	// SxSIÅEΩÅEΩÅEΩÅEΩÅEΩ»ÇÔøΩNo hacer nada
...
BOOL CSoundPage::OnInitDialog()
{
	...
	// ÅEΩTÅEΩÅEΩÅEΩvÅEΩÅEΩÅEΩÅEΩÅEΩOÅEΩÅEΩÅEΩ[ÅEΩgInitialization
	for (i=0; i<5; i++) {
	...
	// ÅEΩoÅEΩbÅEΩtÅEΩ@ÅEΩTÅEΩCÅEΩYInitialization
	...
	// ÅEΩ|ÅEΩ[ÅEΩÅEΩÅEΩÅEΩÅEΩOÅEΩ‘äuInitialization
	...
	// ADPCMÅEΩÅEΩÅEΩ`ÅEΩÅEΩÅEΩInitialization
...
BOOL CVolPage::OnInitDialog()
{
	...
	if (nPos >= 0) {
		// MIDIÅEΩoÅEΩÕÉfÅEΩoÅEΩCÅEΩXÅEΩÕÉAÅEΩNÅEΩeÅEΩBÅEΩuÅEΩÅEΩÅEΩÅEΩSe puede ajustar el volumen
		pSlider->SetPos(nPos);
		pSlider->EnableWindow(TRUE);
		strLabel.Format(_T(" %d"), ((nPos + 1) * 100) >> 16);
	}
	else {
		// MIDIÅEΩoÅEΩÕÉfÅEΩoÅEΩCÅEΩXÅEΩÕÉAÅEΩNÅEΩeÅEΩBÅEΩuÅEΩ≈Ç»ÇÔøΩÅEΩAÅEΩÅEΩÅEΩÅEΩNo se puede ajustar el volumen
		pSlider->SetPos(0);
		pSlider->EnableWindow(FALSE);
		strLabel.Empty();
	}
...
BOOL CKbdPage::OnInitDialog()
{
	...
	// ÅEΩÅEΩÅEΩ|ÅEΩ[ÅEΩgActualizacion
	UpdateReport();
	...
	// ÅEΩRÅEΩÅEΩÅEΩgÅEΩÅEΩÅEΩ[ÅEΩÅEΩActualizacion
	m_bEnableCtrl = TRUE;
...
void FASTCALL CKbdPage::UpdateReport()
{
	...
	for (nX68=0; nX68<=0x73; nX68++) {
		...
		if (lpszName) {
			// ÅEΩLÅEΩÅEΩÅEΩ»ÉLÅEΩ[ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩBInitialization
			strNext.Empty();
...
void CKbdPage::OnClick(NMHDR * /*pNMHDR*/, LRESULT * /*pResult*/)
{
	...
	// SHIFTÅEΩLÅEΩ[ÅEΩÅEΩOProcesamiento
	if (nPrev == DIK_LSHIFT) {
...
void CKbdPage::OnRClick(NMHDR * /*pNMHDR*/, LRESULT * /*pResult*/)
{
	...
	// ÅEΩÅEΩÅEΩbÅEΩZÅEΩ[ÅEΩWÅEΩ{ÅEΩbÅEΩNÅEΩXÅEΩ≈ÅADeleteÅEΩÃóLÅEΩÅEΩÅEΩÅEΩCheck
	...
	// ÅEΩYÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩWindowsÅEΩLÅEΩ[ÅEΩÅEΩDelete
	m_dwEdit[nWin] = 0;
...
//===========================================================================
//
//	KeyboardÅEΩ}ÅEΩbÅEΩvEditarÅEΩ_ÅEΩCÅEΩAÅEΩÅEΩÅEΩO
//
//===========================================================================
...
CKbdMapDlg::CKbdMapDlg(CWnd *pParent, DWORD *pMap) : CDialog(IDD_KBDMAPDLG, pParent)
{
	...
	// EditarÅEΩfÅEΩ[ÅEΩ^ÅEΩÅEΩÅEΩLÅEΩÅEΩ
	ASSERT(pMap);
	m_pEditMap = pMap;

	// InglesÅEΩ¬ãÔøΩÅEΩ÷ÇÃëŒâÔøΩ
	if (!::IsJapanese()) {
...
//---------------------------------------------------------------------------
//
//	ÅEΩ_ÅEΩCÅEΩAÅEΩÅEΩÅEΩOInitialization
//
//---------------------------------------------------------------------------
BOOL CKbdMapDlg::OnInitDialog()
{
	...
	// ÅEΩXÅEΩeÅEΩ[ÅEΩ^ÅEΩXÅEΩoÅEΩ[ÅEΩÅEΩÅEΩ…à⁄ìÔøΩÅEΩADelete
...
{
	// [CR]ÅEΩ…ÇÔøΩÅEΩFinÅEΩÅEΩ}ÅEΩÅEΩ
}
...
LONG CKbdMapDlg::OnKickIdle(UINT /*uParam*/, LONG /*lParam*/)
{
	...
	// ÅEΩÅEΩÅEΩ›ÇÃÉ}ÅEΩbÅEΩvÅEΩ…è]ÅEΩÅEΩÅEΩƒÅAConversionÅEΩ\ÅEΩÅEΩÅEΩÅEΩÅEΩ
	for (nWin=0; nWin<0x100; nWin++) {
	...
	// SHIFTÅEΩLÅEΩ[ÅEΩÅEΩOProcesamiento(L,RÅEΩÅEΩÅEΩÅEΩÅEΩÌÇπÅEΩÅEΩ)
	bFlg[0x74] = bFlg[0x70];
...
LONG CKbdMapDlg::OnApp(UINT uParam, LONG lParam)
{
	...
	switch (lParam) {
		...
		case WM_LBUTTONDOWN:
			// ÅEΩ^ÅEΩ[ÅEΩQÅEΩbÅEΩgÅEΩÅEΩAsignacionÅEΩLÅEΩ[ÅEΩÅEΩInitialization
		...
		case WM_MOUSEMOVE:
			...
			if (uParam != 0) {
				...
				// ÅEΩYÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩWindowsÅEΩLÅEΩ[ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩAgregar
				for (nWin=0; nWin<0x100; nWin++) {
					if (m_pEditMap[nWin] == uParam) {
...
BOOL CKeyinDlg::OnInitDialog()
{
	...
	// ÅEΩKÅEΩCÅEΩhÅEΩÅEΩ`ÅEΩÅEΩProcesamiento
	...
	// AsignacionÅEΩÅEΩ`ÅEΩÅEΩProcesamiento
	...
	// ÅEΩLÅEΩ[ÅEΩÅEΩ`ÅEΩÅEΩProcesamiento
...
//---------------------------------------------------------------------------
//
//	ÅEΩ_ÅEΩCÅEΩAÅEΩÅEΩÅEΩOGet codigo
//
//---------------------------------------------------------------------------
...
void FASTCALL CKeyinDlg::OnDraw(CDC *pDC)
{
	...
	// Restaurar fuente(ObjetosÅEΩÅEΩDeleteÅEΩÅEΩÅEΩ»ÇÔøΩÅEΩƒÇÊÇ¢)
	pDC->SelectObject(pFont);
}
...
void CMousePage::OnPort()
{
	...
	// ConexionÅEΩÅEΩÅEΩ»ÇÔøΩ or ÅEΩÅEΩÅEΩÃÉ|ÅEΩ[ÅEΩgÅEΩ≈îÔøΩÅEΩÅEΩ
	if (pButton->GetCheck()) {
		EnableControls(FALSE);
	}
	else {
...
BOOL CJoyPage::OnInitDialog()
{
	...
	for (i=0; i<2; i++) {
		...
		// ÅEΩŒâÔøΩButtonsÅEΩÅEΩInitialization
		OnSelChg(pComboBox);
	}
...
void CJoyPage::OnOK()
{
	...
	for (i=0; i<CInput::JoyDevices; i++) {
		...
		for (nButton=0; nButton<CInput::JoyButtons; nButton++) {
			// AsignacionÅEΩÅEΩRapid-fireÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ
			if (i == 0) {
				// Puerto 1
...
{
	// CInputÅEΩ…ëŒÇÔøΩÅEΩƒì∆éÔøΩÅEΩÅEΩApplyCfg(ÅEΩ›íÔøΩÅEΩEditarÅEΩOÅEΩ…ñﬂÇÔøΩ)
...
void FASTCALL CJoyPage::OnSelChg(CComboBox *pComboBox)
{
	...
	// ÅEΩŒâÔøΩButtonsÅEΩÅEΩÅEΩÊìæ
	pButton = GetCorButton(pComboBox->GetDlgCtrlID());
	if (!pButton) {
		return;
	}

	// Cuadro combinadoÅEΩÃëIÅEΩÅEΩÅEΩÛãµÇ…ÇÔøΩÅEΩÅEΩƒåÔøΩÅEΩﬂÇÔøΩ
	if (pComboBox->GetCurSel() == 0) {
		// (AsignacionÅEΩ»ÇÔøΩ)ÅEΩÅEΩButtonsÅEΩÅEΩÅEΩÅEΩ
...
void FASTCALL CJoyPage::OnDetail(UINT nButton)
{
	...
	// ÅEΩIÅEΩÅEΩ‘çÔøΩÅEΩìæÇÔøΩ
	nType = pComboBox->GetCurSel();
	if (nType == 0) {
		return;
	}

	// ÅEΩIÅEΩÅEΩ‘çÔøΩÅEΩÅEΩÅEΩÅEΩAGet nombre
	pComboBox->GetLBText(nType, strDesc);

	// ÅEΩpÅEΩÅEΩÅEΩÅEΩÅEΩ[ÅEΩ^ÅEΩÅEΩnÅEΩÅEΩÅEΩAExecute dialogo
...
void FASTCALL CJoyPage::OnSetting(UINT nButton)
{
	...
	// ÅEΩfÅEΩoÅEΩCÅEΩXÅEΩCÅEΩÅEΩÅEΩfÅEΩbÅEΩNÅEΩXÅEΩÊìæ
	nJoy = -1;
	switch (pComboBox->GetDlgCtrlID()) {
		...
		// Otros(ÅEΩQÅEΩ[ÅEΩÅEΩÅEΩRÅEΩÅEΩÅEΩgÅEΩÅEΩÅEΩ[ÅEΩÅEΩÅEΩ≈ÇÕÇ»ÇÔøΩÅEΩfÅEΩoÅEΩCÅEΩX)
		default:
			return;
	}
	...
	// Cuadro combinadoÅEΩÃëIÅEΩÅEΩ‘çÔøΩÅEΩìæÇÔøΩ
	nCombo = pComboBox->GetCurSel();
	if (nCombo == 0) {
		// AsignacionÅEΩÅEΩÅEΩÅEΩ
		return;
	}

	// Cuadro combinadoÅEΩÃëIÅEΩÅEΩ‘çÔøΩÅEΩìæÇÔøΩB0(AsignacionÅEΩÅEΩÅEΩÅEΩ)ÅEΩÅEΩÅEΩÅEΩÅEΩe
	pComboBox = (CComboBox*)GetDlgItem(IDC_JOY_PORTC1);
	ASSERT(pComboBox);
	...
	// ÅEΩÅEΩÅEΩ›ÇÃÉWÅEΩÅEΩÅEΩCÅEΩXÅEΩeÅEΩBÅEΩbÅEΩNÅEΩ›íÔøΩÅEΩ€ëÔøΩ
	m_pInput->GetJoyCfg(nJoy, &cfg);

	// ÅEΩpÅEΩÅEΩÅEΩÅEΩÅEΩ[ÅEΩ^ÅEΩ›íÔøΩ
	sheet.SetParam(nJoy, nCombo, nType);

	// Execute dialogo(ÅEΩWÅEΩÅEΩÅEΩCÅEΩXÅEΩeÅEΩBÅEΩbÅEΩNÅEΩÿÇÔøΩ÷ÇÔøΩÅEΩÅEΩÅEΩÅEΩÅEΩ›ÅACancelarÅEΩ»ÇÔøΩ›íÔøΩﬂÇÔøΩ)
...
//---------------------------------------------------------------------------
//
//	ÅEΩŒâÔøΩÅEΩÅEΩÅEΩÅEΩButtonsÅEΩÅEΩÅEΩÊìæ
//
//---------------------------------------------------------------------------
CButton* CJoyPage::GetCorButton(UINT nComboBox)
{
	...
	// Tabla de controlesÅEΩÅEΩBusqueda
	for (i=0; ; i+=2) {
		// ÅEΩIÅEΩ[Check
		if (ControlTable[i] == NULL) {
			return NULL;
		...
		if (ControlTable[i] == nComboBox) {
			// ÅEΩŒâÔøΩÅEΩÅEΩÅEΩÅEΩButtonsÅEΩìæÇÔøΩ
...
//
//	Tabla de controles
//	ÅEΩÅEΩCuadro combinadoÅEΩÅEΩButtonsÅEΩ∆ÇÃëÔøΩÅEΩ›ëŒâÔøΩÅEΩÅEΩÅEΩ∆ÇÈÇΩÅEΩÅEΩ
//
//---------------------------------------------------------------------------
...
BOOL CJoyDetDlg::OnInitDialog()
{
	...
	// ÅEΩWÅEΩÅEΩÅEΩCÅEΩXÅEΩeÅEΩBÅEΩbÅEΩNDelete
	delete pDevice;
...
CBtnSetPage::CBtnSetPage()
{
	...
	// ÅEΩWÅEΩÅEΩÅEΩCÅEΩXÅEΩeÅEΩBÅEΩbÅEΩNÅEΩ‘çÔøΩÅEΩÅEΩLimpiar
	m_nJoy = -1;

	// ÅEΩ^ÅEΩCÅEΩvÅEΩ‘çÔøΩÅEΩÅEΩLimpiar
...
BOOL CBtnSetPage::OnInitDialog()
{
	...
	// ÅEΩeÅEΩNÅEΩÅEΩÅEΩXÅEΩÅEΩInitialization(CPropertySheetÅEΩÅEΩOnInitDialogÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ»ÇÔøΩ)
	...
	for (nButton=0; nButton<CInput::JoyButtons; nButton++) {
		...
		ASSERT(pStatic);
		if (nButton < nButtons) {
			// ÅEΩLÅEΩÅEΩ(ÅEΩEÅEΩBÅEΩÅEΩÅEΩhÅEΩEDelete)
		...
		ASSERT(pComboBox);
		if (nButton < nButtons) {
			// ÅEΩLÅEΩÅEΩ(ÅEΩÅEΩÅEΩÅEΩAgregar)
			pComboBox->ResetContent();
			...
			// ÅEΩ|ÅEΩ[ÅEΩgÅEΩAButtonsÅEΩÅEΩÅEΩÅEΩÅEΩ
			for (nPort=0; nPort<PPI::PortMax; nPort++) {
				...
				for (nCandidate=0; nCandidate<PPI::ButtonMax; nCandidate++) {
					// ÅEΩWÅEΩÅEΩÅEΩCÅEΩXÅEΩeÅEΩBÅEΩbÅEΩNÅEΩfÅEΩoÅEΩCÅEΩXÅEΩÅEΩÅEΩÅEΩButtonsGet nombre
				...
				// ÅEΩÅEΩÅEΩWÅEΩÅEΩÅEΩCÅEΩXÅEΩeÅEΩBÅEΩbÅEΩNÅEΩfÅEΩoÅEΩCÅEΩXÅEΩÅEΩDelete
				delete pJoyDevice;
			}
		...
		ASSERT(pStatic);
		if (nButton < nButtons) {
			// ÅEΩLÅEΩÅEΩ(ÅEΩÅEΩÅEΩÅEΩÅEΩlMostrar)
			OnSlider(nButton);
			OnSelChg(nButton);
		}
		else {
			// ÅEΩÅEΩÅEΩÅEΩ(Limpiar)
			strText.Empty();
			pStatic->SetWindowText(strText);
		}
	}

	// ButtonsÅEΩÅEΩÅEΩÅEΩÅEΩlÅEΩ«Ç›éÔøΩÅEΩ
	for (nButton=0; nButton<CInput::JoyButtons; nButton++) {
...
void CBtnSetPage::OnHScroll(UINT /*nSBCode*/, UINT /*nPos*/, CScrollBar *pBar)
{
	...
	// ÅEΩRÅEΩÅEΩÅEΩgÅEΩÅEΩÅEΩ[ÅEΩÅEΩIDÅEΩÅEΩÅEΩÊìæ
	pSlider = (CSliderCtrl*)pBar;
	nID = pSlider->GetDlgCtrlID();

	// ButtonsÅEΩCÅEΩÅEΩÅEΩfÅEΩbÅEΩNÅEΩXÅEΩÅEΩBusqueda
	for (nButton=0; nButton<CInput::JoyButtons; nButton++) {
		if (GetControl(nButton, BtnRapid) == nID) {
			// Rutina dedicadaÅEΩÅEΩÅEΩƒÇÔøΩ
			OnSlider(nButton);
			break;
		}
	}
...
void FASTCALL CBtnSetPage::OnDraw(CDC *pDC, BOOL *pButton, BOOL bForce)
{
	...
	// ButtonsBucle
	for (nButton=0; nButton<CInput::JoyButtons; nButton++) {
		// ÅEΩLÅEΩÅEΩ(MostrarÅEΩÅEΩÅEΩ◊ÇÔøΩ)ButtonsÅEΩÅEΩÅEΩ€ÇÔøΩ
		if ((m_rectLabel[nButton].left == 0) && (m_rectLabel[nButton].top == 0)) {
			// ButtonsÅEΩÅEΩÅEΩ»ÇÔøΩÅEΩÃÇ≈ÅAÅEΩÅEΩÅEΩÅEΩÅEΩ…ÇÔøΩÅEΩÍÇΩÅEΩXÅEΩ^ÅEΩeÅEΩBÅEΩbÅEΩNÅEΩeÅEΩLÅEΩXÅEΩg
			continue;
		}

		// !bForceÅEΩ»ÇÔøΩAÅEΩÅEΩrÅEΩÅEΩÅEΩÅEΩAceptar
		if (!bForce) {
			ASSERT(pButton);
			if (m_bButton[nButton] == pButton[nButton]) {
				// ÅEΩÅEΩvÅEΩÅEΩÅEΩƒÇÔøΩÅEΩÅEΩÃÇÔøΩDibujarÅEΩÅEΩÅEΩ»ÇÔøΩ
				continue;
			}
			// Difieren, guardar
...
void CBtnSetPage::OnTimer(UINT /*nTimerID*/)
{
	...
	// ÅEΩtÅEΩÅEΩÅEΩOInitialization
	bFlag = FALSE;

	// ÅEΩÅEΩÅEΩ›ÇÃÉWÅEΩÅEΩÅEΩCÅEΩXÅEΩeÅEΩBÅEΩbÅEΩNButtonsÅEΩÅEΩÅEΩÅEΩ«Ç›éÔøΩÅEΩAÅEΩÅEΩr
	for (nButton=0; nButton<CInput::JoyButtons; nButton++) {
	...
	// ÅEΩtÅEΩÅEΩÅEΩOÅEΩÅEΩÅEΩ„Ç™ÅEΩÅEΩÅEΩƒÇÔøΩÅEΩÅEΩŒÅAÅEΩÅEΩDibujar
	if (bFlag) {
		pDC = new CClientDC(this);
...
void CBtnSetPage::OnOK()
{
	...
	for (nButton=0; nButton<CInput::JoyButtons; nButton++) {
		// ÅEΩLÅEΩÅEΩÅEΩÅEΩButtonsÅEΩÅEΩ
		if (nButton >= nButtons) {
			// ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩButtonsÅEΩ»ÇÃÇ≈ÅAAsignacionÅEΩERapid-fireÅEΩ∆ÇÔøΩÅEΩÅEΩ0
		...
		// (AsignacionÅEΩ»ÇÔøΩ)Check
		if (nSelect == 0) {
			// ÅEΩÅEΩÅEΩÅEΩAsignacionÅEΩ»ÇÔøΩAAsignacionÅEΩERapid-fireÅEΩ∆ÇÔøΩÅEΩÅEΩ0
			cfg.dwButton[nButton] = 0;
			cfg.dwRapid[nButton] = 0;
			continue;
		}
...
//---------------------------------------------------------------------------
//
//	ÅEΩXÅEΩÅEΩÅEΩCÅEΩ_Modificacion
//
//---------------------------------------------------------------------------
void FASTCALL CBtnSetPage::OnSlider(int nButton)
{
	...
	// ÅEΩ|ÅEΩWÅEΩVÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÊìæ
	pSlider = (CSliderCtrl*)GetDlgItem(GetControl(nButton, BtnRapid));
	ASSERT(pSlider);
	nPos = pSlider->GetPos();

	// ÅEΩŒâÔøΩÅEΩÅEΩÅEΩÅEΩEtiquetaÅEΩÅEΩÅEΩÊìæ
	pStatic = (CStatic*)GetDlgItem(GetControl(nButton, BtnValue));
	ASSERT(pStatic);

	// Set valuees desde la tabla
	if ((nPos >= 0) && (nPos <= CInput::JoyRapids)) {
		// ÅEΩ≈íËè¨ÅEΩÅEΩÅEΩ_Procesamiento
...
void FASTCALL CBtnSetPage::OnSelChg(int nButton)
{
	...
	// ÅEΩŒâÔøΩÅEΩÅEΩÅEΩÅEΩXÅEΩÅEΩÅEΩCÅEΩ_ÅEΩAEtiquetaÅEΩÅEΩÅEΩÊìæ
	pSlider = (CSliderCtrl*)GetDlgItem(GetControl(nButton, BtnRapid));
	ASSERT(pSlider);
	pStatic = (CStatic*)GetDlgItem(GetControl(nButton, BtnValue));
	ASSERT(pStatic);
...
void FASTCALL CJoySheet::SetParam(int nJoy, int nCombo, int nType[])
{
	...
	// ÅEΩLÅEΩÅEΩ(Cuadro combinadoÅEΩÅEΩ-1)
	m_nJoy = nJoy;
	m_nCombo = nCombo - 1;
	for (i=0; i<PPI::PortMax; i++) {
		m_nType[i] = nType[i];
...
void FASTCALL CJoySheet::InitSheet()
{
	...
	// ÅEΩEÅEΩBÅEΩÅEΩÅEΩhÅEΩEÅEΩeÅEΩLÅEΩXÅEΩgEditar
...
BOOL CSASIPage::OnInitDialog()
{
	...
	// InitializationÅEΩtÅEΩÅEΩÅEΩOUpÅEΩANumber of drivesÅEΩÊìæ
	m_bInit = TRUE;
	...
	// ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩXÅEΩCÅEΩbÅEΩ`ÅEΩÅEΩÅEΩÅEΩActualizacion
	...
	// ÅEΩÅEΩÅEΩXÅEΩgControl settings
	...
	// ÅEΩÅEΩÅEΩXÅEΩgÅEΩRÅEΩÅEΩÅEΩgÅEΩÅEΩÅEΩ[ÅEΩÅEΩActualizacion
	UpdateList();
...
BOOL CSASIPage::OnSetActive()
{
	...
	// Controles activados/desactivados
	if (bEnable) {
		// ÅEΩLÅEΩÅEΩÅEΩÃèÍçáÅEΩAÅEΩXÅEΩsÅEΩÅEΩButtonsÅEΩÅEΩÅEΩÁåªÅEΩ›ÇÔøΩNumber of drivesÅEΩÅEΩÅEΩÊìæ
		pSpin = (CSpinButtonCtrl*)GetDlgItem(IDC_SASI_DRIVES);
		ASSERT(pSpin);
		if (pSpin->GetPos() > 0 ) {
...
void CSASIPage::OnOK()
{
	...
	// CheckÅEΩ{ÅEΩbÅEΩNÅEΩX(SASIÅEΩESCSIÅEΩ∆ÇÔøΩÅEΩÅEΩÅEΩ ê›íÔøΩ)
	pButton = (CButton*)GetDlgItem(IDC_SASI_MEMSWB);
	ASSERT(pButton);
	if (pButton->GetCheck() == 1) {
...
void FASTCALL CSASIPage::UpdateList()
{
	...
	// ÅEΩÅEΩÅEΩXÅEΩgÅEΩRÅEΩÅEΩÅEΩgÅEΩÅEΩÅEΩ[ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ»ÇÔøΩÅEΩÅEΩÅEΩÅEΩÅEΩÕÅAAgregarÅEΩÅEΩÅEΩÅEΩ
	...
	// ÅEΩÅEΩÅEΩfÅEΩBCheck(m_nDriveÅEΩÅEΩÅEΩÅEΩÅEΩ‹Ç∆ÇﬂÇƒçsÅEΩ»ÇÔøΩ)
	CheckSASI(dwDisk);

	// ÅEΩÅEΩrBucle
	for (i=0; i<nCount; i++) {
		// ÅEΩÅEΩÅEΩfÅEΩBCheckÅEΩÃåÔøΩÅEΩ Ç…ÇÔøΩÅEΩAÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩCreate
		if (dwDisk[i] == 0) {
			// Desconocido
			strDisk = m_strError;
		}
...
int FASTCALL CSASIPage::GetDrives(const Config *pConfig) const
{
	...
	// InitializationÅEΩÅEΩÅEΩÅEΩƒÇÔøΩÅEΩ»ÇÔøΩÅEΩÅEΩŒÅAÅEΩ^ÅEΩÅEΩÅEΩÅEΩÍÇΩConfigÅEΩÅEΩÅEΩÅEΩ
	if (!m_bInit) {
		return pConfig->sasi_drives;
	}

	// InitializationÅEΩœÇ›Ç»ÇÔøΩAÅEΩÅEΩÅEΩ›ÇÃílÅEΩÅEΩ
	return m_nDrives;
}
...
CSxSIPage::CSxSIPage()
{
	...
	// Initialization(OtrosÅEΩfÅEΩ[ÅEΩ^)
	m_nSASIDrives = 0;
	for (i=0; i<8; i++) {
		m_DevMap[i] = DevNone;
	}
...
BOOL CSxSIPage::OnInitDialog()
{
	...
	// InitializationÅEΩtÅEΩÅEΩÅEΩOUp
	m_bInit = TRUE;
	...
	// SASIÅEΩÃê›íÔøΩNumber of drivesÅEΩÅEΩÅEΩÅEΩASCSIÅEΩ…ê›íÔøΩ≈ÇÔøΩÅEΩÅEΩ≈ëÔøΩNumber of drivesÅEΩìæÇÔøΩ
	...
	// SCSIÅEΩÃç≈ëÔøΩNumber of drivesÅEΩêßåÔøΩ
	...
	// SCSIÅEΩÅEΩNombre de archivoÅEΩÅEΩÅEΩÊìæ
	for (i=0; i<6; i++) {
...
BOOL CSxSIPage::OnSetActive()
{
	...
	// SASIÅEΩÅEΩNumber of drivesÅEΩÅEΩÅEΩÊìæÅEΩÅEΩÅEΩASCSIÅEΩÃç≈ëÔøΩNumber of drivesÅEΩìæÇÔøΩ
	m_nSASIDrives = pSASIPage->GetDrives(m_pConfig);
	nMax = m_nSASIDrives;
	nMax = (nMax + 1) >> 1;
	ASSERT((nMax >= 0) && (nMax <= 8));
	...
	if (bEnable) {
		if (nPos > 0) {
			...
			// ÅEΩÅEΩÅEΩXÅEΩgÅEΩLÅEΩÅEΩÅEΩEÅEΩhÅEΩÅEΩÅEΩCÅEΩuÅEΩÅEΩÅEΩÅEΩ
			EnableControls(FALSE, TRUE);
		}
	}
	else {
...
{
	// ÅEΩÅEΩÅEΩXÅEΩgÅEΩRÅEΩÅEΩÅEΩgÅEΩÅEΩÅEΩ[ÅEΩÅEΩActualizacion(ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩBuildMapÅEΩÅEΩÅEΩsÅEΩÅEΩ)
	UpdateList();
...
//---------------------------------------------------------------------------
//
//	CheckÅEΩ{ÅEΩbÅEΩNÅEΩXModificacion
//
//---------------------------------------------------------------------------
...
void FASTCALL CSxSIPage::UpdateList()
{
	...
	// ÅEΩÅEΩÅEΩXÅEΩgGet controlÅEΩAÅEΩJÅEΩEÅEΩÅEΩÅEΩgÅEΩÊìæ
	pListCtrl = (CListCtrl*)GetDlgItem(IDC_SXSI_LIST);
	ASSERT(pListCtrl);
	nCount = pListCtrl->GetItemCount();
...
void FASTCALL CSxSIPage::BuildMap()
{
	...
	// Flag de prioridad MOÅEΩÅEΩÅEΩÊìæ
	pButton = (CButton*)GetDlgItem(IDC_SXSI_MOCHECK);
	ASSERT(pButton);
	bMOFirst = FALSE;
	if (pButton->GetCheck() != 0) {
	...
	// SASINumber of drivesÅEΩÅEΩÅEΩÅEΩASASIÅEΩÃêÔøΩLIDÅEΩÅEΩÅEΩìæÇÔøΩ
	...
	// SxSINumber of drivesÅEΩÃê›íÔøΩÅEΩÅEΩÅEΩÅEΩƒÅAÅEΩlÅEΩí≤êÔøΩ
	pSpin = (CSpinButtonCtrl*)GetDlgItem(IDC_SXSI_DRIVES);
	ASSERT(pSpin);
	nMax = LOWORD(pSpin->GetPos());
	ASSERT((nMax >= 0) && (nMax <= (nSCSI + nMO)));
	if (nMax == 0) {
		// SxSINumber of drivesÅEΩÅEΩ0
		nMO = 0;
		nSCSI = 0;
	}
	else {
...
//---------------------------------------------------------------------------
//
//	SCSIÅEΩnÅEΩ[ÅEΩhÅEΩfÅEΩBÅEΩXÅEΩNCapacityCheck
...
int FASTCALL CSxSIPage::CheckSCSI(int nDrive)
{
	...
	// ÅEΩtÅEΩ@ÅEΩCÅEΩÅEΩÅEΩTÅEΩCÅEΩYÅEΩÅEΩCheck(512ÅEΩoÅEΩCÅEΩgÅEΩPÅEΩÅEΩ)
	if ((dwSize & 0x1ff) != 0) {
		return 0;
	}

	// ÅEΩtÅEΩ@ÅEΩCÅEΩÅEΩÅEΩTÅEΩCÅEΩYÅEΩÅEΩCheck(10MBÅEΩ»èÔøΩ)
	if (dwSize < 10 * 0x400 * 0x400) {
		return 0;
	}

	// ÅEΩtÅEΩ@ÅEΩCÅEΩÅEΩÅEΩTÅEΩCÅEΩYÅEΩÅEΩCheck(1016MBÅEΩ»âÔøΩ)
...
void CSxSIPage::EnableControls(BOOL bEnable, BOOL bDrive)
{
	...
	// ÅEΩÅEΩÅEΩXÅEΩgÅEΩRÅEΩÅEΩÅEΩgÅEΩÅEΩÅEΩ[ÅEΩÅEΩÅEΩEMOCheckÅEΩ»äOÅEΩÃëSÅEΩRÅEΩÅEΩÅEΩgÅEΩÅEΩÅEΩ[ÅEΩÅEΩÅEΩÅEΩ›íÔøΩ
	for (i=0; ; i++) {
		// Get control
		if (!ControlTable[i]) {
			break;
	...
	// ÅEΩÅEΩÅEΩXÅEΩgÅEΩRÅEΩÅEΩÅEΩgÅEΩÅEΩÅEΩ[ÅEΩÅEΩÅEΩÅEΩ›íÔøΩ
	pListCtrl = (CListCtrl*)GetDlgItem(IDC_SXSI_LIST);
	ASSERT(pListCtrl);
	pListCtrl->EnableWindow(bEnable);
...
int FASTCALL CSxSIPage::GetDrives(const Config *pConfig) const
{
	...
	if (pSASIPage->GetDrives(pConfig) >= 12) {
		// SASINumber of drivesÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩBSxSIÅEΩÕégÅEΩpÅEΩ≈ÇÔøΩÅEΩ»ÇÔøΩ
		bEnable = FALSE;
	}
	...
	// ÅEΩÅEΩInitializationÅEΩÃèÍçáÅEΩAÅEΩ›íÔøΩlÅEΩÅEΩ‘ÇÔøΩ
	if (!m_bInit) {
		return pConfig->sxsi_drives;
	}

	// ÅEΩÅEΩÅEΩÅEΩEditarÅEΩÅEΩÅEΩÃílÅEΩÅEΩ‘ÇÔøΩ
	pSpin = (CSpinButtonCtrl*)GetDlgItem(IDC_SXSI_DRIVES);
	ASSERT(pSpin);
	nPos = LOWORD(pSpin->GetPos());
	return nPos;
...
BOOL CSCSIPage::OnInitDialog()
{
	...
	// ROMÅEΩÃóLÅEΩÅEΩÅEΩ…âÔøΩÅEΩÅEΩÅEΩƒÅAÅEΩCÅEΩÅEΩÅEΩ^ÅEΩtÅEΩFÅEΩ[ÅEΩXÅEΩÅEΩÅEΩWÅEΩIButtonsÅEΩÅEΩÅEΩ÷é~
	...
	switch (m_pConfig->mem_type) {
		...
		// Externo
		case Memory::SCSIExt:
			// ExternoROMÅEΩÅEΩÅEΩÅEΩÅEΩ›ÇÔøΩÅEΩÅEΩÍçÅEøΩÃÇÔøΩ
			if (bEnable[0]) {
				pButton = (CButton*)GetDlgItem(IDC_SCSI_EXTB);
				bAvail = TRUE;
			}
		...
		// Otros(Interno)
		default:
			// InternoROMÅEΩÅEΩÅEΩÅEΩÅEΩ›ÇÔøΩÅEΩÅEΩÍçÅEøΩÃÇÔøΩ
			if (bEnable[1]) {
				pButton = (CButton*)GetDlgItem(IDC_SCSI_INTB);
				bAvail = TRUE;
			}
...
void CSCSIPage::OnOK()
{
	...
	// Tipo de interfazÅEΩÅEΩÅEΩÁÉÅEøΩÅEΩÅEΩÅEΩÅEΩÅEΩ ê›íÔøΩ
	switch (GetIfCtrl()) {
		// No instalar
		case 0:
		...
		// Interno
		case 2:
			// ÅEΩ^ÅEΩCÅEΩvÅEΩÅEΩÅEΩ·Ç§ÅEΩÍçÅEøΩÃÇ›ÅASCSIIntÅEΩÅEΩModificacion
...
//---------------------------------------------------------------------------
//
//	ÅEΩÅEΩÅEΩWÅEΩIButtonsModificacion
//
//---------------------------------------------------------------------------
void CSCSIPage::OnButton()
{
	...
	// ÅEΩCÅEΩÅEΩÅEΩ^ÅEΩtÅEΩFÅEΩ[ÅEΩXÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩCheckÅEΩÅEΩÅEΩÅEΩƒÇÔøΩÅEΩÈÇ©
	pButton = (CButton*)GetDlgItem(IDC_SCSI_NONEB);
	ASSERT(pButton);
	if (pButton->GetCheck() != 0) {
		// Lista inactiva / Unit inactiva
...
int FASTCALL CSCSIPage::GetInterface(const Config *pConfig) const
{
	...
	// InitializationÅEΩtÅEΩÅEΩÅEΩO
	if (!m_bInit) {
		// InitializationÅEΩÅEΩÅEΩÅEΩƒÇÔøΩÅEΩ»ÇÔøΩÅEΩÃÇ≈ÅAConfigÅEΩÅEΩÅEΩÅEΩÊìæ
	...
	// InitializationÅEΩÅEΩÅEΩÅEΩƒÇÔøΩÅEΩÅEΩÃÇ≈ÅAÅEΩRÅEΩÅEΩÅEΩgÅEΩÅEΩÅEΩ[ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÊìæ
	return GetIfCtrl();
}

//---------------------------------------------------------------------------
//
//	Tipo de interfazÅEΩÊìæ(ÅEΩRÅEΩÅEΩÅEΩgÅEΩÅEΩÅEΩ[ÅEΩÅEΩÅEΩÅEΩÅEΩ)
//
//---------------------------------------------------------------------------
...
BOOL FASTCALL CSCSIPage::CheckROM(int nType) const
{
	...
	// 0:InternoÅEΩÃèÍçáÅEΩÕñÔøΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩOK
	if (nType == 0) {
		return TRUE;
	}
	...
	// ÅEΩtÅEΩ@ÅEΩCÅEΩÅEΩÅEΩTÅEΩCÅEΩYÅEΩÊìæ
	dwSize = fio.GetFileSize();
	fio.Close();
	::UnlockVM();

	if (nType == 1) {
		// ExternoÅEΩÕÅA0x2000ÅEΩoÅEΩCÅEΩgÅEΩ‹ÇÔøΩÅEΩÅEΩ0x1fe0ÅEΩoÅEΩCÅEΩg(WinX68kÅEΩÅEΩÅEΩÅEΩÅEΩ≈Ç∆å›äÔøΩÅEΩÅEΩÅEΩ∆ÇÔøΩ)
		if ((dwSize == 0x2000) || (dwSize == 0x1fe0)) {
			return TRUE;
		}
	}
	else {
		// InternoÅEΩÕÅA0x2000ÅEΩoÅEΩCÅEΩgÅEΩÃÇÔøΩ
		if (dwSize == 0x2000) {
			return TRUE;
		}
	}
...
void FASTCALL CSCSIPage::BuildMap()
{
	...
	// ÅEΩfÅEΩBÅEΩXÅEΩNÅEΩÅEΩÅEΩÅEΩAceptar
	switch (m_nDrives) {
		// 0ÅEΩÅEΩ
		case 0:
			break;
		...
		// 1ÅEΩÅEΩ
		case 1:
			// Prioridad MOÅEΩÅEΩÅEΩAPrioridad HDÅEΩÅEΩÅEΩ≈ïÔøΩÅEΩÅEΩÅEΩÅEΩ
			if (m_bMOFirst) {
				bMO = TRUE;
			}
			else {
...
int FASTCALL CSCSIPage::CheckSCSI(int nDrive)
{
	...
	// ÅEΩtÅEΩ@ÅEΩCÅEΩÅEΩÅEΩTÅEΩCÅEΩYÅEΩÅEΩCheck(4095MBÅEΩ»âÔøΩ)
...
BOOL CMIDIPage::OnInitDialog()
{
	...
	// Cuadro combinadoÅEΩÅEΩCursorÅEΩÅEΩ›íÔøΩ
...
void CMIDIPage::OnBIDClick()
{
	...
	// CheckÅEΩÅEΩÅEΩ¬ÇÔøΩÅEΩƒÇÔøΩÅEΩÈÇ©ÅEΩ«ÇÔøΩÅEΩÅEΩÅEΩ≈íÔøΩÅEΩ◊ÇÔøΩ
	if (pButton->GetCheck() == 1) {
		EnableControls(FALSE);
	}
	else {
...
BOOL CAlterPage::OnInitDialog()
{
	...
	// InitializationÅEΩœÇ›ÅAÅEΩpÅEΩÅEΩÅEΩeÅEΩBÅEΩtÅEΩÅEΩÅEΩOÅEΩÅEΩÅEΩÊìæÅEΩÅEΩÅEΩƒÇÔøΩÅEΩÅEΩ
	m_bInit = TRUE;
...
BOOL CAlterPage::OnKillActive()
{
	...
	// CheckÅEΩ{ÅEΩbÅEΩNÅEΩXÅEΩÅEΩÅEΩpÅEΩÅEΩÅEΩeÅEΩBÅEΩtÅEΩÅEΩÅEΩOÅEΩ…îÔøΩÅEΩfÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ
...
//---------------------------------------------------------------------------
//
//	SASIÅEΩpÅEΩÅEΩÅEΩeÅEΩBÅEΩ@ÅEΩ\Check
//
//---------------------------------------------------------------------------
BOOL FASTCALL CAlterPage::HasParity(const Config *pConfig) const
{
	...
	// InitializationÅEΩÅEΩÅEΩÅEΩƒÇÔøΩÅEΩ»ÇÔøΩÅEΩÅEΩŒÅAÅEΩ^ÅEΩÅEΩÅEΩÍÇΩConfigÅEΩfÅEΩ[ÅEΩ^ÅEΩÅEΩÅEΩÅEΩ
	if (!m_bInit) {
		return pConfig->sasi_parity;
	}

	// InitializationÅEΩœÇ›Ç»ÇÔøΩAÅEΩ≈êVÅEΩÅEΩEditarÅEΩÅEΩÅEΩ ÇÔøΩmÅEΩÁÇπÅEΩÅEΩ
	return m_bParity;
}
...
#endif
{
	...
	// ÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÊìæ
	lpszKey = m_pTKey->GetKeyID(nTarget);
	if (lpszKey) {
		// Hay cadena de tecla, nueva configuracion
		m_nKey = nTarget;

		// ÅEΩRÅEΩÅEΩÅEΩgÅEΩÅEΩÅEΩ[ÅEΩÅEΩÅEΩ…ê›íÔøΩAÅEΩÅEΩDibujar
		m_strKey = lpszKey;
		Invalidate(FALSE);
	}
}
...
void CTKeyPage::OnClick(NMHDR* /*pNMHDR*/, LRESULT* /*pResult*/)
{
	...
	// Get los datos apuntados por ese indice(1ÅEΩ`0x73)
	nKey = (int)pListCtrl->GetItemData(nItem);
...
void CTKeyPage::OnRClick(NMHDR* /*pNMHDR*/, LRESULT* /*pResult*/)
{
	...
	// ÅEΩÅEΩÅEΩ≈ÇÔøΩDeleteÅEΩÅEΩÅEΩÅEΩƒÇÔøΩÅEΩÅEΩÅEΩNo hacer nada
	if (m_nKey[nKey - 1] == 0) {
		return;
	}
...
void FASTCALL CTKeyPage::UpdateReport()
{
	...
	for (nKey=1; nKey<=0x73; nKey++) {
		...
		if (lpszKey) {
			...
			// VKAsignacionÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩŒÅAGet nombre
			nVK = m_nKey[nKey - 1];
			if (nVK != 0) {
...
void FASTCALL CTKeyPage::EnableControls(BOOL bEnable)
{
	...
	// WindowsCheckÅEΩ{ÅEΩbÅEΩNÅEΩXÅEΩÊìæ
	pButton = (CButton*)GetDlgItem(IDC_TKEY_WINC);
	ASSERT(pButton);
	bCheck = FALSE;
	if (pButton->GetCheck() != 0) {
	...
	for(i=0; ; i++) {
		...
		// ControlTable[i]ÅEΩÅEΩIDC_TKEY_MAPG, IDC_TKEY_LISTÅEΩÕìÔøΩÅEΩÅEΩ
		switch (ControlTable[i]) {
			...
			// OtrosÅEΩÅEΩbEnableÅEΩ…è]ÅEΩÅEΩ
			default:
				pWnd->EnableWindow(bEnable);
		}
	}
...
//===========================================================================
//
//	ConfigurationÅEΩvÅEΩÅEΩÅEΩpÅEΩeÅEΩBÅEΩVÅEΩ[ÅEΩg
//
//===========================================================================
...
int CConfigSheet::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	// TimerÅEΩÅEΩÅEΩCÅEΩÅEΩÅEΩXÅEΩgÅEΩ[ÅEΩÅEΩ
...
#endif
{
	...
	// InfoÅEΩÅEΩÅEΩÅEΩÅEΩ›ÇÔøΩÅEΩÅEΩŒÅAActualizacion
	...
	// TimerÅEΩƒäJ(MostrarÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ100msÅEΩÅEΩÅEΩÅEΩÅEΩÅEΩ)
	m_nTimerID = SetTimer(IDM_OPTIONS, 100, NULL);
}
